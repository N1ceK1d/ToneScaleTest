                    ...
                    <div class="employee-body p-1">
                        <?php
                            ...
                            <table class="table table-bordered ">
                                <caption>
                                Предупреждение! не стоит полагаться на результат теста на 100%. Существует возможность неправильного заполнения и что какие-либо данные теста окажутся неправильными и следует приходить к заключению в первую очередь из собственных наблюдений.
                                </caption>
                                <thead>
                                    <tr>
                                        <td class='text-center'><b>уровень эмоционального состояния</b></td>
